...
> **Liên quan:** [labeled_corpus_collection_plan.md](./labeled_corpus_collection_plan.md) · [HUONG_DAN_GAN_NHAN.md](../../research/label_studio_pipeline/HUONG_DAN_GAN_NHAN.md) · [nomfoundation_storage_ocr_metadata_gaps.md](./nomfoundation_storage_ocr_metadata_gaps.md) · [consolidated_session_report_08_2026.md](./consolidated_session_report_08_2026.md)
...
| Env | `research/label_studio_pipeline/.env`: `LABEL_STUDIO_API_KEY`, `LABEL_STUDIO_URL`, `GEMINI_API_KEY` (nếu re-label) |
| Schema LS | Entity: `PER_NAME`, `GENERATION`, `DATE`, `ORDER`, `LOC` · Relation: `FATHER_OF`, `MOTHER_OF`, `SPOUSE` — xem [HUONG_DAN_GAN_NHAN.md §2–3](../../research/label_studio_pipeline/HUONG_DAN_GAN_NHAN.md) |
...
| File | Nội dung |
|------|----------|
| [HUONG_DAN_GAN_NHAN.md](../../research/label_studio_pipeline/HUONG_DAN_GAN_NHAN.md) | Schema nhãn chi tiết |
