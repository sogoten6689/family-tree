...
> **SSOT tham chiếu:** [CRAWL_PLAN.md § Phần F](../methods/CRAWL_PLAN.md#phần-f--pipeline-7-bước--hiển-thị-step-ssot), [vietnamgiapha_crawl_v2_plan.md](./vietnamgiapha_crawl_v2_plan.md), [rule_based_genealogy_extraction_steps.md](./rule_based_genealogy_extraction_steps.md)
...
| Tài liệu | Nội dung |
|----------|----------|
| [CRAWL_PLAN.md](../methods/CRAWL_PLAN.md) | Pipeline 7 bước, skip rules, document types |
...
| [FEATURES.md](../product/FEATURES.md) | Feature map UI hiện tại |
