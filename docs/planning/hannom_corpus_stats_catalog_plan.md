...
> **Trạng thái:** ✅ Phase A · 2026-08-24 thêm 3 cuốn Word `24_8_2026` (bản dịch, không scan)  
...
### 3.4. Word biên dịch (`24_8_2026/`) — 2026-08-24

Không phải scan Hán-Nôm. Là **bản dịch / phiên âm Quốc ngữ** (một cuốn kèm chữ Hán). Đưa catalog với `source=local_docx`, `kind=gia_pha_dich`, **không** cộng vào “trang ảnh”, **không** OCR.

| book_id | Nhan đề | File | Trang Word | Ghi chú |
|---------|---------|------|------------|---------|
| `docx-pham-1876` | Gia phả + Phó ý họ Phạm | `GIA PHẢ + PHÓ Ý HỌ PHẠM.docx` | 26 | Dịch 2018; gốc Tự Đức 30 (1876); dịch nghĩa + phiên âm |
| `docx-nguyen-van` | Gia phả Nguyễn Văn | `Gia phả Nguyễn Văn.docx` | 24 | I dịch · II phiên âm · III Hán (1975); ~7 đời |
| `docx-tran-200` | Gia phả họ Trần (Huế) | `gia pha ho tran 200.docx` | 20 | GSL HN.2011.11.200; dịch 2018; tu phổ 1890; thiếu phả đồ |

**Tổng cuốn catalog:** 15 Nom + 1 Gia phả chí + 3 PDF tông phả + 3 Word + 2 sách lý thuyết = **24 cuốn**.

### 3.3. Có trong source — sách lý thuyết (đưa catalog `kind=ly_thuyet`, không OCR)

| Path | Vai trò |
|------|--------|
| `data/sach/Gia phả học tinh hoa.pdf` | Lý thuyết Quốc ngữ; đối chiếu loại/bố cục |
| `data/sach/3742.pdf` | *Hướng dẫn viết gia phả* |
| `data/gia_pha/`, `data/vgp_corpus/` | Phả ký Quốc ngữ VGP — **không** catalog Hán-Nôm |
...
**Tổng cuốn đưa vào catalog v1:** 15 Nom + 1 Gia phả chí + 3 PDF = **19 cuốn**. Cập nhật 2026-08-24: **+3 Word dịch + 2 sách lý thuyết** → **24 cuốn**.
...
- [x] `data/hannom/books_catalog.json` liệt kê đủ 19 cuốn (cập nhật 22 khi thêm Word 24/08).
...
| `data/du_lieu_han_nom_moi/24_8_2026/{book_id}.md` | ✅ phân tích từng Word |
| `data/du_lieu_han_nom_moi/24_8_2026/thong_ke.md` | ✅ bảng so sánh 3 cuốn |
| `nlp_family_extractor/tools/write_docx_analysis.py` | ✅ sinh MD |
