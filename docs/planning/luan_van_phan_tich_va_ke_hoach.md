...
Lộ trình thực hiện chi tiết (nhãn dữ liệu, triage `planning/`, freeze demo, khép User, baseline đo):  
→ [repo_organization_execution_plan.md](./repo_organization_execution_plan.md) — bắt đầu **H0**, chưa chuyển folder corpus.

1. **Dán đề cương** vào §0.  
2. Viết giúp (hoặc nhờ agent sau): bảng map *chương đề cương ↔ phase §5.2*.  
3. Chốt 1 câu đóng góp + 1 happy path + tên 1–2 tư liệu mẫu (**H2** trong file trên).  
4. Khi sẵn sàng implement: H0 → H1 → H2 trước; không refactor NLP lớn trước K1.
...
| File | Dùng cho |
|------|----------|
| [business.md](../thesis/business.md) | Mục tiêu đề tài, nhóm công việc nghiệp vụ |
| [PROJECT.md](../product/PROJECT.md) | Kiến trúc, route, API |
| [FEATURES.md](../product/FEATURES.md) | Spec Guest/User/Admin, hai zone song song |
...
| [repo_organization_execution_plan.md](./repo_organization_execution_plan.md) | Lộ trình H0–H5 + K1 (tổ chức repo / demo / baseline) |
