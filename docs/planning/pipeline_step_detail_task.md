...
> **Ngày:** 2026-07-10  
> **SSOT tham chiếu:** [CRAWL_PLAN.md § Phần F](../methods/CRAWL_PLAN.md#phần-f--pipeline-7-bước--hiển-thị-step-ssot)
...
|----------|-------------------|
| [CRAWL_PLAN.md § F](../methods/CRAWL_PLAN.md#phần-f--pipeline-7-bước--hiển-thị-step-ssot) | 7 bước, skip rules, UX spec |
| [RESEARCH_SOURCES.md](../thesis/RESEARCH_SOURCES.md) | ID `vgp-{n}`, nguồn VGP |
| [FEATURES.md](../product/FEATURES.md) | Tab admin (cần bổ sung Pipeline) |
