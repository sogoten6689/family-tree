...
**Tài liệu liên quan:** [CRAWL_PLAN.md § Phần A](../methods/CRAWL_PLAN.md), [RESEARCH_SOURCES.md §3](../thesis/RESEARCH_SOURCES.md), [pipeline_step_detail_task.md](./pipeline_step_detail_task.md)
