...
│   ├── api.py
│   ├── app/                 # auth, documents, hannom, family_tree_store
│   ├── data/                # mirror runtime (không phải corpus luận văn)
│   └── tools/               # OCR lab, crawl sync
│
├── research/                # label_studio_pipeline + source_discovery
├── docs/                    # Đọc: thesis / product / methods / lab / planning / schemas
│   └── REPO_MAP.md
├── data/                    # Corpus luận văn — 00_raw … 05_ops
├── infra/                   # nginx + docker-compose.yml + script build
└── readme.md
```
...
- **Module:** `research/label_studio_pipeline/`
...
- **Tài liệu:** [HUONG_DAN_GAN_NHAN.md](../../research/label_studio_pipeline/HUONG_DAN_GAN_NHAN.md) · [THONG_KE.md](../../research/label_studio_pipeline/THONG_KE.md) · [plan](../planning/label_studio_pipeline_plan.md)
- **Chạy:** `PYTHONPATH=research python -m label_studio_pipeline.crawl_corpus` → `python -m label_studio_pipeline.label_and_import`
...
| [RESEARCH_SOURCES.md](../thesis/RESEARCH_SOURCES.md) | **Nguồn tư liệu nghiên cứu** (Nom Foundation, vietnamgiapha crawl, corpus) |
| [CRAWL_PLAN.md](../methods/CRAWL_PLAN.md) | **Kế hoạch nâng cấp crawl** (skip trùng VGP + text + Nom auto) |
...
| [business.md](../thesis/business.md) | Phân tích nghiệp vụ & kiến trúc đề tài |
