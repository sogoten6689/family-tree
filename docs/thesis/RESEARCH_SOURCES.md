...
### 4.1. Sách lý thuyết đã đọc (`data/04_external/sach/`)

Không đưa vào gold OCR. Dùng để đối chiếu **loại phả / bố cục** (tuần 17/08: glossary với Lâm Hoài Phương).

| File | Vai trò |
|------|---------|
| `Gia phả học tinh hoa.pdf` | Sách gia phả học hiện đại (Quốc ngữ) |
| `3742.pdf` | *Hướng dẫn viết gia phả* (metadata PDF) |
| `so_do_kien_thuc.png` | Sơ đồ kiến thức kèm thư mục |

### 4.2. Corpus đã đọc kỹ (layout / dịch)

| book_id | Nhan đề | Ghi chú đọc |
|---------|---------|-------------|
| `gpc-dang-1928` | Gia phả chí họ Đặng, Bảo Đại 1928 | Bìa → tựa → thờ tứ thân → phả ký → đời sau → văn tế (17 trang) |
| `docx-pham-1876` | Gia phả + Phó ý họ Phạm | Dịch 2018; gốc 1876 |
| `docx-nguyen-van` | Gia phả Nguyễn Văn | Dịch + phiên âm + Hán (1975) |
| `docx-tran-200` | Gia phả họ Trần (Huế) | GSL HN.2011.11.200; dịch 2018 |

Catalog HTML: `data/00_raw/hannom/index.html` (mục «Nguồn sách / tư liệu đã đọc»).

### 4.3. Nguồn web đã khảo sát (2026-08-09)

Xem `data/05_ops/sources_discovery/sources_registry.json`: Nom Foundation, NLV, vietnamgiapha.com, giaphaonline.net (thu thập); giaphavietnam.vn (pilot); giaphadaiviet.vn (tạm bỏ).
...
Pipeline **7 bước** (mỗi bước có thể skip): Tên → Ảnh Hán-Nôm → OCR → Ký tự Hán → Quốc ngữ → **Cô đọng gia phả** → **Cây hoặc VB gia phả**. Chi tiết: [CRAWL_PLAN.md § Phần F](../methods/CRAWL_PLAN.md#phần-f--pipeline-7-bước--hiển-thị-step-ssot).
...
| File | Nội dung |
|------|----------|
| [PROJECT.md](../product/PROJECT.md) | Kiến trúc, API, tích hợp Kim Hán Nôm |
| [FEATURES.md](../product/FEATURES.md) | Spec tính năng crawl, kho tư liệu |
