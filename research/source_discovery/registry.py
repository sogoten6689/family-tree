...
DEFAULT_REGISTRY = Path("data/05_ops/sources_discovery/sources_registry.json")
DEFAULT_DISCOVERY_DIR = Path("data/05_ops/sources_discovery")
    ...
    for seed in SEED_SOURCES:
        ...
        if seed.get("status") == "active_collector":
            ...
            if source_id == "vietnamgiapha":
                entry["collected"] = {"trees": 2152, "tier_a": 101, "path": "data/00_raw/vgp_corpus/"}
            if source_id == "nomfoundation_c2":
                entry["collected"] = {"volumes": 5, "pages": 163, "path": "data/00_raw/hannom/nomfoundation/"}
