...
| Export | `python -m label_studio_pipeline.export_ls_gold` → `data/02_gold/gold_labels/v1_human/` |
| Review queue | `data/02_gold/gold_labels/REVIEW_QUEUE.md` (thứ tự S1→S4) |
