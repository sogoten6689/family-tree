...
from label_studio_pipeline.data_layout import (
    DERIVED_REVIEW_CORPUS,
    INTERIM_SYNTHETIC,
    RAW_HANNOM,
)

DEFAULT_CORPUS_DIR = DERIVED_REVIEW_CORPUS
DEFAULT_QUOC_NGU_DIR = DERIVED_REVIEW_CORPUS / "quoc_ngu"
DEFAULT_HANNOM_DIR = DERIVED_REVIEW_CORPUS / "hannom"
DEFAULT_SYNTHETIC_DIR = INTERIM_SYNTHETIC
DEFAULT_NOM_SOURCE_DIR = RAW_HANNOM / "nomfoundation" / "volumes"
