...
from label_studio_pipeline.data_layout import RAW_VGP_CORPUS
...
DEFAULT_TIER_A = RAW_VGP_CORPUS / "tier_a_trees.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", type=Path, default=RAW_VGP_CORPUS / "ls_audit_report.json")
