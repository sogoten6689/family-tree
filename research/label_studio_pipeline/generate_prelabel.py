...
from label_studio_pipeline.data_layout import INTERIM_PRELABELS, RAW_VGP_CORPUS
from label_studio_pipeline.pilot_file import resolve_tree_ids

DEFAULT_CORPUS_DIR = RAW_VGP_CORPUS
DEFAULT_OUTPUT_DIR = INTERIM_PRELABELS
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Directory for pre-label JSON outputs (default: data/01_interim/prelabels).",
    )
