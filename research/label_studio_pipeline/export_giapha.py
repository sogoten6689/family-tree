"""CLI — export gia phả folders to data/03_derived/gia_pha/."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export each gia phả to data/03_derived/gia_pha/{tree_id}/ with metadata.json, pha_ky.txt, pha_he.json.",
    )
