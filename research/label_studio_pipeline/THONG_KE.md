...
> **Cập nhật:** 2026-08-02 — **đóng băng lịch sử Label Studio.**  
> Số liệu đĩa hiện tại: [`data/DATA_INVENTORY.md`](../../data/DATA_INVENTORY.md) (2026-08-27: **2.152** cây crawl, **342** hợp lệ).  
> **Nguồn (lúc viết file này):** `data/00_raw/vgp_corpus/`, `data/01_interim/gemini_labels/`  
> **Plan:** [label_studio_pipeline_plan.md](../../docs/planning/label_studio_pipeline_plan.md)
...
data/01_interim/gemini_labels/{tree_id}/
...
python -m label_studio_pipeline.label_and_import \
  --pilot-file data/00_raw/vgp_corpus/batch_trees.json --cross-check
```
