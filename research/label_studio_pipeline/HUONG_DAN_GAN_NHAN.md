...
> **Thống kê corpus:** [THONG_KE.md](./THONG_KE.md) · **Plan:** [label_studio_pipeline_plan.md](../docs/planning/label_studio_pipeline_plan.md)  
...
File `data/01_interim/gemini_labels/{tree_id}/cross_check.json` báo:
...
Map sang [genealogy_extraction_feature_set_plan.md](../docs/planning/genealogy_extraction_feature_set_plan.md):
