...
from label_studio_pipeline.data_layout import GOLD_LABELS, GOLD_STRATIFIED, RAW_VGP_CORPUS

DEFAULT_TIER_SUMMARY = RAW_VGP_CORPUS / "tier_summary.json"
DEFAULT_GOLD_DIR = GOLD_LABELS
DEFAULT_OUTPUT = GOLD_STRATIFIED
